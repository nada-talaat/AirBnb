...
namespace Airbnbfinal.Controllers
{
    public class CityController : Controller
    {
        ...
        public CityController(Graduationproject1Context context)
        {
            _context = context;
        }
        ...
        {
            var graduationproject1Context = _context.Cities.Include(h => h.Hotels);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Graduationproject1Context.Cities'  is null.");
            }
            var city = await _context.Cities.FindAsync(id);
            if (city != null)
            {
